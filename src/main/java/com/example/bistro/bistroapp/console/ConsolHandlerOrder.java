...
@Component
public class ConsolHandlerOrder {
    ...
    public ConsolHandlerOrder(ProductService productService, CustomerService customerService, IngredientService ingredientService, CustomerRepository customerRepository, OrderRepository orderRepository, ProductRepository productRepository, OrderService orderService) {
    ...
    public void printTopMostWantedProducts(int count) {
        List<Product> topProducts = productService.getTopProducts(count);

        System.out.println("Top " + count + " Most Wanted Products:");
